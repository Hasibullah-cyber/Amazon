...
export default function OrderConfirmationPage() {
  ...
  useEffect(() => {
    const data = localStorage.getItem("orderInfo")
    if (data) {
      setOrderInfo(JSON.parse(data))
    }
  }, [])

  if (!orderInfo) return <p className="text-center mt-10">Loading your order...</p>

  const { items = [], address, payment, summary } = orderInfo
      ...
      <div className="container mx-auto px-4 max-w-4xl">
        ...
        <Card className="p-8 text-center mb-6 bg-green-50 border-green-200">
          ...
          <div className="bg-white p-4 rounded-md inline-block">
            ...
            <p className="text-xl font-bold text-black">#{orderInfo?.orderNumber || "HS-2025-XXXXXX"}</p>
          </div>
        </Card>
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <Card className="p-6">
              <h2 className="text-xl font-medium text-black mb-4 flex items-center">
                <Truck className="h-5 w-5 mr-2" /> Delivery Information
              </h2>
              <div className="space-y-3">
                ...
                <div className="bg-blue-50 p-3 rounded-md">
                  <p className="text-sm text-blue-800">
                    <strong>Estimated Delivery:</strong> Within 1-2 business days
                  </p>
                </div>
              </div>
            </Card>
            ...
            <Card className="p-6">
              ...
              <div className="space-y-3">
                ...
                <div className="flex justify-between">
                  ...
                  <span className="font-medium">{payment?.txnId}</span>
                </div>
                <div className="flex justify-between">
